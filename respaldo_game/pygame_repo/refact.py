...
fuente = pygame.font.Font("./assets/fonts/pixelada.ttf", 35)
...
class Game:
    def __init__(self):
        ...
        self.btn_jugar = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2 - 40, 200, 60), "Jugar", VERDE_CLARO, AMARILLO_CLARO)
        self.btn_puntajes = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2 + 40, 200, 60), "Puntajes", GRIS, AMARILLO_CLARO)
        
        self.btn_facil = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2 - 100, 200, 50), "Bebe Lloron", VERDE_CLARO, AMARILLO_CLARO)
        self.btn_normal = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2, 200, 50), "Normal", AMARILLO_TEXTO, AMARILLO_CLARO)
        self.btn_dificil = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2 + 100, 200, 50), "HARDCORE", ROJO_TEXTO, ROJO_CLARO, BLANCO)
        self.btn_volver_menu = Boton(pygame.Rect(20, ALTO - 70, 200, 50), "Volver", GRIS, AMARILLO_CLARO)
        
        self.btn_volver_scores = Boton(pygame.Rect(ANCHO - 220, ALTO - 70, 200, 50), "Volver", GRIS, AMARILLO_CLARO)
        ...
        self.btn_volver_gameover = Boton(pygame.Rect(ANCHO // 2 - 100, ALTO // 2 + 150, 200, 50), "Volver al Menu", GRIS, AMARILLO_CLARO)
